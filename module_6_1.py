...
Пункты задачи:
Создайте классы Animal и Plant с соответствующими атрибутами и методами атрибутами и методами. При необходимости
...
class Plant:  # растения
    def __init__(self, name):
        self.name = name  # индивидуальное название каждого растения 4 класса наследника
...
print('Хищник:', predator.name)
print('Млекопитающее:', mammal.name)
print('Цветок:', flower.name)
print('Фрукт:', fruit.name)
print(predator.name, f'Живой? {predator.alive} Накормленный? {predator.fed}')
print(mammal.name, f' Живой? {mammal.alive} Накормленный? {mammal.fed}')

predator.eat(flower)  # волк поел цветик семицветик
mammal.eat(fruit)  # хатико поел заводной апельсин
print(predator.name, 'живой? ', predator.alive)  # живой
print(mammal.name, 'накормленный?',mammal.fed )  # накормленный
