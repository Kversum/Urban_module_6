...
class Vehicle:  # любой транспорт
    def __init__(self, owner, model, color, engin_pover):
        self.owner = owner                # (str) владелец транспорта. Владелец может меняться.
        self.__model = model              # (str) Мы не можем менять название модели своими руками
        self.__engin_pover = engin_pover  # (int) мощность двигателя. Мы не можем менять мощность ДВС своими руками
        self.__color = None                 # (str) Мы не можем менять цвет а/м своими руками
        self.set_color(color)

    __COLOR_VARIANTS = ['белый', 'черный', 'красный', 'металик']  # список допустимых цветов для окрашивания.

    def get_model(self):  # возвращает строку: "Модель: <название модели транспорта>"
        return f'Модель: {self.__model}'

    def get_horsepower(self):  # возвращает строку: "Мощность ДВС: <мощность>"
        return f'Мощность двигателя: {self.__engin_pover}'
...
vehicle1 = Sedan('Федор', 'Toyota Mark II', 'белый', 500)
vehicle1.print_info()
